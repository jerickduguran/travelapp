...
class FlightConnectingAdmin extends Admin
{
    ...
    {
        $formMapper
            ->add('type','choice', array('choices' => array('TO' => 'To Destination','FROM'=> 'From Destination')))
            ->add('destination')
            ->add('arrivalSchedule','sonata_type_datetime_picker',
